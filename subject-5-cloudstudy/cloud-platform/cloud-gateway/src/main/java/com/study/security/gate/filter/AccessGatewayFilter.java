package com.study.security.gate.filter;

import com.alibaba.fastjson.JSONObject;
import com.study.security.gate.feign.ILogService;
...
import com.study.security.auth.client.jwt.UserAuthUtil;
...
import com.study.security.common.msg.auth.TokenForbiddenResponse;
...
//    private ServiceAuthUtil serviceAuthUtil;
    ...
    public Mono<Void> filter(ServerWebExchange serverWebExchange, GatewayFilterChain gatewayFilterChain) {
        ...
        // 不进行拦截的地址
        if (isStartWith(requestUri) || StringUtils.endsWithIgnoreCase(requestUri, endWith)) {
